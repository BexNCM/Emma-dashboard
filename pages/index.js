...
// Fetch full email body via the Make fetch_body route (Scenario B, Emma's delegated connection).
// Returns plain text. Replaces the dead app-only /api/get-email Netlify function.
